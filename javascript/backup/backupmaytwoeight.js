...
function updateSelectedIndicator(selectedAccordion) {
	
	// Determine the selected indicator based on the selectedAccordion parameter
	// switch (selectedAccordion) {
	//   case "accordion1":
	// 	selectedIndicator = "# acres urban green space per 1,000 residents";
	// 	break;
	//   case "accordion2":
	// 	selectedIndicator = "# Brownfields and Superfund sites";
	// 	break;
	//   case "accordion3":
	// 	selectedIndicator = "# drinking water violations per year";
	// 	break;
	//   case "accordion4":
	// 	selectedIndicator = "# poor air quality days per year";
	// 	break;
	//   case "accordion5":
	// 	selectedIndicator = "% properties with recycling services";
	// 	break;
	//   case "accordion6":
	// 	selectedIndicator = "# microgrids or district energy systems";
	// 	break;
	//   case "accordion7":
	// 	selectedIndicator = "# KW produced by renewables";
	// 	break;
	//   default:
	// 	selectedIndicator = "None";
	// }

	// selectedIndicator = selectedOption.parentElement.parentElement.textContent.trim();
...
function update(accordionId) {
	
	if(Year){
		applyYear(accordionId);
		selectedOption = accordionId;
		updateSelectedIndicator(accordionId);
	}else{
		applyYearRange(accordionId);
		selectedOption = accordionId;
		updateSelectedIndicator(accordionId);
	}
}
